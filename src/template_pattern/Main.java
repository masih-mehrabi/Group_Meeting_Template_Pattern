...
public final class Main {
	...
	public static void main(String[] args) throws MalformedURLException {
		...
		VirtualTutorGroupMeeting virtualTutorGroup = new VirtualTutorGroupMeeting(timeSlot2, tutorGroup2,
				softwareQualityManagement, new URL("https://tum-conf.zoom.us/j/99711605391?pwd=R3NjVGs2Y2lReVVXdk1ZaFBSMk9sUT09"));
		virtualTutorGroup.practice();

		TimeSlot timeSlot3 = new TimeSlot(DayOfWeek.MONDAY, LocalTime.of(11, 0), LocalTime.of(13, 0));
		Student tutor3 = new Student("Julia", 21, "ge25quo", "1234567891", 4);
		TutorGroup tutorGroup3 = new TutorGroup("Mo11", timeSlot3, tutor3);

		Student studentPrivate = new Student("Marie", 19, "ga55ram", "03894457", 2);
		...
		PrivateTutorGroupMeeting privateTutorGroup = new PrivateTutorGroupMeeting(timeSlot3, tutorGroup3,
				softwareQualityManagement, "Leopoldstraße 250");
